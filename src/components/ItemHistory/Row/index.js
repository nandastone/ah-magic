  ...
  return (
    <tr>
      <td>
        ...
        {item.type === 'sale' ? ` (${prettySaleType})` : null}
      </td>
      <td>
      ...
      <td>
        {item.bid ? (
          <div>
            Bid: <WowCurrency value={item.bid} />
          </div>
        ) : null}
        {item.price ? (
          <div>
      ...
      <td>
        {item.createdOn ? (
          <span>
            {moment(item.createdOn).format('D MMM YYYY, h:mm:ss a')}
      ...
      <td>
        {item.endedOn
          ? moment(item.endedOn).format('D MMM YYYY, h:mm:ss a')
          : null}
      </td>
    </tr>
  )
