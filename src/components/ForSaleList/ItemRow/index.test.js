...
const unlistedItem = {
  ...item,
  history: [
    { key: 'key-1', type: 'purchase', cost: 19550, createdAt: '2018-03-10T07:10:39+10:00' },
    { key: 'key-2', type: 'listing', bid: 100000, price: 129500, cost: 5000, createdAt: '2018-03-11T07:11:39+10:00', endedAt: '2018-03-12T07:12:39+10:00' },
    { key: 'key-3', type: 'listing', bid: 100000, price: 119500, cost: 0, createdAt: '2018-03-13T07:11:39+10:00', endedAt: '2018-03-14T07:12:39+10:00' }
  ]
}
...
const listedItem = {
  ...
  history: [
    { key: 'key-1', type: 'purchase', cost: 19550, createdAt: '2018-03-10T07:10:39+10:00' },
    { key: 'key-2', type: 'listing', bid: 100000, price: 129500, cost: 5000, createdAt: '2018-03-11T07:11:39+10:00', endedAt: '2018-03-12T07:12:39+10:00' },
    { key: 'key-3', type: 'listing', bid: 100000, price: 119500, cost: 0, createdAt: '2018-03-13T07:11:39+10:00' }
  ]
}
...
describe('ItemRow component', () => {
  ...
  it('renders correctly', () => {
    const tree = renderer
      .create(<ItemRow item={unlistedItem} />)
      .toJSON()
  ...
  it('it should open the list item form modal when the "list" button is clicked', () => {
    const wrapper = shallow(<ItemRow item={unlistedItem} />)
    wrapper.find('[data-test="list-button"]').simulate('click', { stopPropagation: () => {} })
  ...
  it('it should open the sold item form modal when the "sold" button is clicked', () => {
    const wrapper = shallow(<ItemRow item={listedItem} />)
    wrapper.find('[data-test="sold-button"]').simulate('click', { stopPropagation: () => {} })
  ...
  it('it should call the onEnd prop when the "end" button is clicked', () => {
    ...
    wrapper.find('[data-test="end-button"]').simulate('click', { stopPropagation: () => {} })
  ...
  it('it should call the onDelete prop when accepting the delete confirmation', () => {
    ...
    wrapper.find('[data-test="delete-button"]').simulate('click', { stopPropagation: () => {} })
